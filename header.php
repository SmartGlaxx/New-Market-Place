...
.speech-bubble:after {
 ...
 <div class="topnav" >
  ...
  <div id='menu_div' style='color:black; background: white; text-align: center; height:100vh;position:absolute; margin-top:-40px; z-index: 200;background:;'>
...
<a class="navbar-brand non_dis" id='upw' href="index.php">
  	<div class='upwork' style='z-index:3'><img src ='images/xx.png'class='up'style='scale:1.2; margin-top:5px' alt='Finder'></div>
  </a>
